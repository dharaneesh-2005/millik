        ...
        <div className="p-5">
          ...
          <div className="flex items-center mb-4">
            <div className="flex text-amber-400">
              ...
              {Array.from({ length: 5 }).map((_, i) => {
                ...
                // Half star (show half star if rating is between this star and the next)
          ...
          <div className="flex justify-between items-center">
            ...
            <motion.button 
              ...
              className="sheen-button bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors text-sm shadow-md flex items-center gap-1"
