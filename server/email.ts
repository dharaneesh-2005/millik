    ...
    const html = `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 800px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background-color: #f9f9f9; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
          ...
          <div style="background-color: #fff; border-radius: 4px; padding: 15px; margin: 15px 0; border-left: 4px solid #4CAF50;">
            ...
            <p style="margin: 5px 0;"><strong>Payment Status:</strong> <span style="background-color: ${
              paymentStatus === 'pending' ? '#FFF59D' : 
              paymentStatus === 'completed' ? '#C8E6C9' : 
              paymentStatus === 'failed' ? '#FFCDD2' : '#f9f9f9'
            }; padding: 2px 8px; border-radius: 12px; font-size: 14px;">${paymentStatus.toUpperCase()}</span></p>
          </div>
        </div>
        ...
        <div style="background-color: #f9f9f9; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
          ...
          <p style="margin: 5px 0;">${order.shippingCity}, ${order.shippingState} ${order.shippingZip}</p>
